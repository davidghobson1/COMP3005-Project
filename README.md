...
An important note: to use the app, Express has to connect to PostgreSQL. To allow this to happen, open the postgres.js file in the /public directory, and on line 6, where it says:
